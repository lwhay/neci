...
public class FileColumnMetaData extends MetaData<FileColumnMetaData> {
  ...
  private transient List<FileColumnMetaData> children =
    new ArrayList<FileColumnMetaData>(0);
  private transient int number = -1;

  private FileColumnMetaData() {}                     // non-public ctor
  ...
  public FileColumnMetaData getParent() { return parent; }

  /** Return this column's children or null. */
  public List<FileColumnMetaData> getChildren() { return children; }
  ...
  static FileColumnMetaData read(InputBuffer in, InsertColumnFileReader file)
    throws IOException {
